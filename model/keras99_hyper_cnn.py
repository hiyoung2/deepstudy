...
print("x_test.reshape :", x_test.shape)    # (10000, 28, 28, 1)
...
def build_model(drop=0.5, optimizer = 'adam') :
    ...
    x = Conv2D(64, (2, 2), activation = 'relu', name = 'hidden1')(inputs)
    x = Dropout(drop)(x)
    x = Conv2D(82, (2, 2), activation = 'relu', name = 'hidden2')(x)
    x = Dropout(drop)(x)
    x = Conv2D(40, (2, 2), activation = 'relu', name = 'hidden3')(x)
    x = Flatten()(x)
    x = Dropout(drop)(x)
